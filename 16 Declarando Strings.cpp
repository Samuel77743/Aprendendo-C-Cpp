...
int main(void)
	...
	printf("comando STRCAT ->> Usado para mesclar conteúdo de duas Strings(como juntar uma string de nome + sobrenome)");
	
	printf("\n\ncomando STRLEN ->> Apresenta o tamanho da String");
